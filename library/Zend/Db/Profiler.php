...
class Zend_Db_Profiler
{
    ...
    public function queryStart($queryText, $queryType = null)
    {
		...
		// Addded by Sangeetha on Mar - 24 2008
		// Sets the query description with the query profiles
		if (isset($this->queryDescription)) {
			$this->_queryProfiles[key($this->_queryProfiles)]->setQueryDescription($this->queryDescription);
		}
        return key($this->_queryProfiles);
    }
