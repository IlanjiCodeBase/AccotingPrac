...
abstract class Zend_Db_Adapter_Pdo_Abstract extends Zend_Db_Adapter_Abstract
{
    ...
    protected function _connect()
    {
        ...
        try {
			...
			//below two lines for server only
			//$this->_connection->setAttribute( PDO::ATTR_ERRMODE, true );
			//$this->_connection->setAttribute( PDO::ERRMODE_EXCEPTION, true );
    ...
    {
	/*if($_SERVER[REMOTE_ADDR] == '121.246.247.15')
	echo '<br>====>'.$sql;*/
	    $this->_connect();
        $stmtClass = $this->_defaultStmtClass;
		// echo 'dfssfdsf:'.$stmtClass;
