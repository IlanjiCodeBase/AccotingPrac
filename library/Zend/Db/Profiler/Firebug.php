...
class Zend_Db_Profiler_Firebug extends Zend_Db_Profiler
{
    ...
    public function setEnabled($enable)
    {
        ...
        if ($this->getEnabled()) {
            ...
            if (!$this->_message) {
                ...
                $this->_message->setHeader(array('Description', 'Time','Event','Parameters'));
    ...
    public function queryEnd($queryId)
    {
		...
		// Addded by Sangeetha on Mar - 24 2008, [first index ==> $profile->getQueryDescription()]
		
        $this->_message->addRow(array($profile->getQueryDescription(), (string)round($profile->getElapsedSecs(),5),
                                      $profile->getQuery(),
